...
def evaluate_language(state: UPSCState):
    prompt = (
        "You are evaluating a UPSC-style essay.\n"
        "Evaluate the LANGUAGE QUALITY (grammar, vocabulary, coherence) and give:\n"
        "1) Detailed feedback\n"
        "2) A score out of 10.\n\n"
        "Essay:\n" + state["essay"]
    )
...
def evaluate_analysis(state: UPSCState):
    prompt = (
        "You are evaluating a UPSC-style essay.\n"
        "Evaluate the DEPTH OF ANALYSIS (argument quality, examples, balance) and give:\n"
        "1) Detailed feedback\n"
        "2) A score out of 10.\n\n"
        "Essay:\n" + state["essay"]
    )
...
def evaluate_thought(state: UPSCState):
    prompt = (
        "You are evaluating a UPSC-style essay.\n"
        "Evaluate the CLARITY OF THOUGHT (structure, flow of ideas, focus) and give:\n"
        "1) Detailed feedback\n"
        "2) A score out of 10.\n\n"
        "Essay:\n" + state["essay"]
    )
...
def final_evaluation(state: UPSCState):
    prompt = (
        ...
        "Given the following dimension-wise feedback, write a short overall evaluation "
        "and do NOT add a new score.\n\n"
        ...
        "Now give a concise final overall feedback paragraph."
    )
